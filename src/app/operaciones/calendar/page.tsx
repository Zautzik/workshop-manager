...
const VALID_TABS = ['calendario', 'semanal'] as const;
    ...
    <Tabs value={active} onValueChange={onChange} className="w-full">
      <TabsList className="grid w-full max-w-md grid-cols-2">
        ...
        <TabsTrigger value="semanal" className="gap-2">
          <CalendarRange className="h-4 w-4" /> Plan Semanal
        </TabsTrigger>
      </TabsList>
      ...
      <div className="p-6 space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Calendario de vencimientos, mantenimiento y licencias · matriz semanal por máquina
          </p>
        </div>
