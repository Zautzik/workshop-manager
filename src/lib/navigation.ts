    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: 'Mantenimiento', href: '/equipos/ordenes',   description: 'Qué está vencido (por calendario o por uso), pautas, checklists y ejecución de órdenes', icon: ClipboardList, color: 'bg-sky-500/10 text-sky-400' },
